...
export const metadata = {
  title: 'GlobeTrotter — Plan your next trip',
  description:
    'GlobeTrotter is a personalized travel planning platform for building itineraries, tracking budgets, and discovering new destinations.',
}
